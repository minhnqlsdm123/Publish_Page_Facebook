                        ...
                        <form class="form-horizontal form-label-left" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group @if ($errors->has('message')) bad @endif">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="message" name="message" value="{{ old('message', $post['message'] ?? '') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-11 col-sm-11 col-xs-9">
                                    @foreach($post['src_photos'] as $item)
                                        <div class="row" style="margin-bottom: 15px;">
                                            <div class="col-md-2">
                                                <img id="image-preview-image_detail" class="img-fluid" src='{{ old('message', $item ?? '') }}'>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="text" name="image_detail[]" value="{{ old('message', $item ?? '') }}" id="image_detail"
                                                       class="form-control" />
                                            </div>
                                            <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <a href="{{ route('admin.PublishPage.list') }}" class="btn btn-info" type="button"><i class="fa fa-list"></i>
                                        Danh sách</a>

                                    <a href="{{ route('admin.PublishPage.update', $post['id']) }}" class="btn btn-warning" type="reset"><i
