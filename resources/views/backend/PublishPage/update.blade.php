                                ...
                                <div class="col-md-11 col-sm-11 col-xs-9">
                                    @foreach($post['src_photos'] as $item)
                                        <div class="row" style="margin-bottom: 15px;">
                                            <div class="col-md-2"><img id="image-preview-image_detail" class="img-fluid" src='{{ old('message', $item ?? '') }}'></div>
                                            <div class="col-md-8"><input type="text" name="image_detail[]" value="{{ old('message', $item ?? '') }}" id="image_detail" class="form-control" /></div>
                                            <div class="col-md-2">
