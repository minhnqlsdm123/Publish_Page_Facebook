                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                @if ($post->file_count > 1 || $post->type == 'VIDED')
                                ...
                                @else
                                    ...
                                    @endforeach
                                    <div class="row text-danger mess-dont-update-file" style="margin: 0px; color: red"><span>Không thể cập nhật ảnh hoặc video</span></div>
                                @endif
                                </div>
                            </div>
