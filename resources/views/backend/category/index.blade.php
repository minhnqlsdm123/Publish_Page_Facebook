                        ...
                        <table class="table table-striped projects">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $k+1 }}</td>
                                    <td>
                                        <a>{{ str_repeat('--', $category['level']).$category['c_name'] }}</a>
                                    </td>
                                    <td>
                                        <img src="{{ asset('backend/images/user.png') }}" class="avatar" alt="Avatar">
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.category.action', ['status', $category['id']]) }}"
                                            class="btn btn-{{ $category->getStatus($category['c_status'])['class'] }} btn-xs">{{ $category->getStatus($category['c_status'])['name'] }}</a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.category.action', ['delete', $category['id']]) }}"
