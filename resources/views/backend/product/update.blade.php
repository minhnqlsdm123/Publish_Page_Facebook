...
<form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                        <input type="number" name="price"
                                            value="{{ old('price', $product->pro_price) }}" class="form-control"
                                            id="price">
                                        @if ($errors->has('price'))
                    ...
                    <div class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="">
                                    <label>
                                        <input type="checkbox" class="js-switch" name="hot" value="1"
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <img id="image-preview-avatar" class="img-fluid"
                                            src="{{ $product->pro_avatar ?? '/backend/build/images/default.jpg' }}">
                                    </div>
                                    <div class="col-md-8">
                                        <input type="text" name="avatar"
                                            value="{{ $product->pro_avatar ?? '/backend/build/images/default.jpg' }}"
                                    ...
                                    <div class="col-md-2">
                                        <div class=" input-group-append">
                                            <button
                                                ...
                                                Chọn</button>
                                            <button onclick="resetInput('avatar')" class="btn btn-danger reset"
                                                data-reset="avatar" type="button"><i class="fa fa-trash"></i>
                                                Xóa</button>
                                        </div>
                                    </div>
                                </div>
    ...
    @if (!empty($product->pro_image_detail))
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="col-md-11 col-sm-11 col-xs-9">
                                @foreach($product->pro_image_detail as $k => $image)
                                <div class="row" style="margin-bottom: 15px;">
                                    ...
                                    <div class="col-md-2">
                                        <div class=" input-group-append">
                                            <button
                                                onclick="open_popup('/filemanager/dialog.php?type=1&popup=1&field_id=image_detail{{ $k }}&akey={{ $keyAccessFileManagerBackend}}')"
                                                class="btn btn-primary" type="button"><i class="fa fa-cloud-upload"></i>
                                                Chọn</button>
                                ...
                                <button onclick="addImage(this, 'image_detail', '{{ $keyAccessFileManagerBackend}}')"
                                    class="btn btn-success w-162" type="button"><i class="fa fa-plus-circle"></i> Thêm
                                    ảnh</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-horizontal form-label-left">
                        <div class="form-group">
                            ...
                            <div class="col-md-11 col-sm-11 col-xs-9">
                                <div class="row" style="margin-bottom: 15px;">
                                    <div class="col-md-2">
                                        <img id="image-preview-image_detail" class="img-fluid"
                                            src='/backend/build/images/default.jpg'>
                                    </div>
                                    <div class="col-md-8">
                                        <input type="text" name="image_detail[]"
                                            value="/backend/build/images/default.jpg" id="image_detail"
                                            class="form-control" />
                                    </div>
                                    <div class="col-md-2">
                                        <div class=" input-group-append">
